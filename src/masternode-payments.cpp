...
void CMasternodePayments::FillBlockPayee(CMutableTransaction& txNew, bool fProofOfStake)
{
    ...
    CAmount blockValue = GetBlockSubsidy(pindexPrev->nHeight, consensusParams, false);
