...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all VESTX related functionality
...
/*
    ...
    allow endless transaction that would bloat VESTX and make it unusable. To
