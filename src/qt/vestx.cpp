...
{
    return QCoreApplication::translate("vestx-core", psz).toStdString();
}
...
void BitcoinApplication::initializeResult(bool success)
{
    ...
    if(success)
    {
        ...
        // vestx: URIs or payment requests:
...
{
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. VESTX can no longer continue safely and will quit.") + QString("\n\n") + message);
    ::exit(EXIT_FAILURE);
}
...
int main(int argc, char *argv[])
{
    ...
    Q_INIT_RESOURCE(vestx);
    Q_INIT_RESOURCE(vestx_locale);
    ...
    // vestx: links repeatedly have their payment requests routed to this process:
