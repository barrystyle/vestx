...
{
    setStyleSheet("QToolTip{border:1px solid #000;background-color:#ffa02f;padding:1px;border-radius:3px;opacity:100}QWidget{color:#b1b1b1;background-color:#323232}QWidget:item:hover{background-color:QLinearGradient(x1: 0,y1: 0,x2: 0,y2: 1,stop: 0 #ffa02f,stop: 1 #ca0619);color:#000}QWidget:item:selected{background-color:QLinearGradient(x1: 0,y1: 0,x2: 0,y2: 1,stop: 0 #ffa02f,stop: 1 #d7801a)}QMenuBar::item{background:0 0}QMenuBar::item:selected{background:0 0;border:1px solid #fa0}QMenuBar::item:pressed{background:#444;border:1px solid #000;background-color:QLinearGradient(x1:0,y1:0,x2:0,y2:1,stop:1 #212121,stop:.4 #343434);margin-bottom:-1px;padding-bottom:1px}QMenu{border:1px solid #000}QMenu::item{padding:2px 20px 2px 20px}QMenu::item:selected{color:#000}QWidget:disabled{color:#404040;background-color:#323232}QAbstractItemView{background-color:QLinearGradient(x1: 0,y1: 0,x2: 0,y2: 1,stop: 0 #4d4d4d,stop: .1 #646464,stop: 1 #5d5d5d)}QLineEdit{background-color:QLinearGradient(x1: 0,y1: 0,x2: 0,y2: 1,stop: 0 #4d4d4d,stop: 0 #646464,stop: 1 #5d5d5d);padding:1px;border-style:solid;border:1px solid #1e1e1e;border-radius:5}QPushButton{color:#b1b1b1;background-color:QLinearGradient(x1: 0,y1: 0,x2: 0,y2: 1,stop: 0 #565656,stop: .1 #525252,stop: .5 #4e4e4e,stop: .9 #4a4a4a,stop: 1 #464646);border-width:1px;border-color:#1e1e1e;border-style:solid;border-radius:6;padding:3px;font-size:12px;padding-left:5px;padding-right:5px}QPushButton:pressed{background-color:QLinearGradient(x1: 0,y1: 0,x2: 0,y2: 1,stop: 0 #2d2d2d,stop: .1 #2b2b2b,stop: .5 #292929,stop: .9 #282828,stop: 1 #252525)}QComboBox{selection-background-color:#fa0;background-color:QLinearGradient(x1: 0,y1: 0,x2: 0,y2: 1,stop: 0 #565656,stop: .1 #525252,stop: .5 #4e4e4e,stop: .9 #4a4a4a,stop: 1 #464646);border-style:solid;border:1px solid #1e1e1e;border-radius:5}QComboBox:hover,QPushButton:hover{border:2px solid QLinearGradient(x1: 0,y1: 0,x2: 0,y2: 1,stop: 0 #ffa02f,stop: 1 #d7801a)}QComboBox:on{padding-top:3px;padding-left:4px;background-color:QLinearGradient(x1: 0,y1: 0,x2: 0,y2: 1,stop: 0 #2d2d2d,stop: .1 #2b2b2b,stop: .5 #292929,stop: .9 #282828,stop: 1 #252525);selection-background-color:#fa0}QComboBox QAbstractItemView{border:2px solid #a9a9a9;selection-background-color:QLinearGradient(x1: 0,y1: 0,x2: 0,y2: 1,stop: 0 #ffa02f,stop: 1 #d7801a)}QComboBox::drop-down{subcontrol-origin:padding;subcontrol-position:top right;width:15px;border-left-width:0;border-left-color:#a9a9a9;border-left-style:solid;border-top-right-radius:3px;border-bottom-right-radius:3px}QComboBox::down-arrow{image:url(:/down_arrow.png)}QGroupBox:focus{border:2px solid QLinearGradient(x1: 0,y1: 0,x2: 0,y2: 1,stop: 0 #ffa02f,stop: 1 #d7801a)}QTextEdit:focus{border:2px solid QLinearGradient(x1: 0,y1: 0,x2: 0,y2: 1,stop: 0 #ffa02f,stop: 1 #d7801a)}QScrollBar:horizontal{border:1px solid #222;background:QLinearGradient(x1: 0,y1: 0,x2: 0,y2: 1,stop: 0 #121212,stop: .2 #282828,stop: 1 #484848);height:7px;margin:0 16px 0 16px}QScrollBar::handle:horizontal{background:QLinearGradient(x1: 0,y1: 0,x2: 1,y2: 0,stop: 0 #ffa02f,stop: .5 #d7801a,stop: 1 #ffa02f);min-height:20px;border-radius:2px}QScrollBar::add-line:horizontal{border:1px solid #1b1b19;border-radius:2px;background:QLinearGradient(x1: 0,y1: 0,x2: 1,y2: 0,stop: 0 #ffa02f,stop: 1 #d7801a);width:14px;subcontrol-position:right;subcontrol-origin:margin}QScrollBar::sub-line:horizontal{border:1px solid #1b1b19;border-radius:2px;background:QLinearGradient(x1: 0,y1: 0,x2: 1,y2: 0,stop: 0 #ffa02f,stop: 1 #d7801a);width:14px;subcontrol-position:left;subcontrol-origin:margin}QScrollBar::left-arrow:horizontal,QScrollBar::right-arrow:horizontal{border:1px solid #000;width:1px;height:1px;background:#fff}QScrollBar::add-page:horizontal,QScrollBar::sub-page:horizontal{background:0 0}QScrollBar:vertical{background:QLinearGradient(x1: 0,y1: 0,x2: 1,y2: 0,stop: 0 #121212,stop: .2 #282828,stop: 1 #484848);width:7px;margin:16px 0 16px 0;border:1px solid #222}QScrollBar::handle:vertical{background:QLinearGradient(x1: 0,y1: 0,x2: 0,y2: 1,stop: 0 #ffa02f,stop: .5 #d7801a,stop: 1 #ffa02f);min-height:20px;border-radius:2px}QScrollBar::add-line:vertical{border:1px solid #1b1b19;border-radius:2px;background:QLinearGradient(x1: 0,y1: 0,x2: 0,y2: 1,stop: 0 #ffa02f,stop: 1 #d7801a);height:14px;subcontrol-position:bottom;subcontrol-origin:margin}QScrollBar::sub-line:vertical{border:1px solid #1b1b19;border-radius:2px;background:QLinearGradient(x1: 0,y1: 0,x2: 0,y2: 1,stop: 0 #d7801a,stop: 1 #ffa02f);height:14px;subcontrol-position:top;subcontrol-origin:margin}QScrollBar::down-arrow:vertical,QScrollBar::up-arrow:vertical{border:1px solid #000;width:1px;height:1px;background:#fff}QScrollBar::add-page:vertical,QScrollBar::sub-page:vertical{background:0 0}QTextEdit{background-color:#242424}QPlainTextEdit{background-color:#242424}QHeaderView::section{background-color:QLinearGradient(x1:0,y1:0,x2:0,y2:1,stop:0 #616161,stop: .5 #505050,stop: .6 #434343,stop:1 #656565);color:#fff;padding-left:4px;border:1px solid #6c6c6c}QCheckBox:disabled{color:#414141}QDockWidget::title{text-align:center;spacing:3px;background-color:QLinearGradient(x1:0,y1:0,x2:0,y2:1,stop:0 #323232,stop: .5 #242424,stop:1 #323232)}QDockWidget::close-button,QDockWidget::float-button{text-align:center;spacing:1px;background-color:QLinearGradient(x1:0,y1:0,x2:0,y2:1,stop:0 #323232,stop: .5 #242424,stop:1 #323232)}QDockWidget::close-button:hover,QDockWidget::float-button:hover{background:#242424}QMainWindow::separator{background-color:QLinearGradient(x1:0,y1:0,x2:0,y2:1,stop:0 #161616,stop: .5 #151515,stop: .6 #212121,stop:1 #343434);color:#fff;padding-left:4px;border:1px solid #4c4c4c;spacing:3px}QMainWindow::separator:hover{background-color:QLinearGradient(x1:0,y1:0,x2:0,y2:1,stop:0 #d7801a,stop:.5 #b56c17 stop:1 #ffa02f);color:#fff;padding-left:4px;border:1px solid #6c6c6c;spacing:3px}QToolBar::handle{spacing:3px;background:url(:/images/handle.png)}QMenu::separator{height:2px;background-color:QLinearGradient(x1:0,y1:0,x2:0,y2:1,stop:0 #161616,stop: .5 #151515,stop: .6 #212121,stop:1 #343434);color:#fff;padding-left:4px;margin-left:10px;margin-right:5px}QProgressBar{border:2px solid grey;border-radius:5px;text-align:center}QProgressBar::chunk{background-color:#d7801a;width:2.15px;margin:.5px}QTabBar::tab{color:#b1b1b1;border:1px solid #444;border-bottom-style:none;background-color:#323232;padding-left:10px;padding-right:10px;padding-top:3px;padding-bottom:2px;margin-right:-1px}QTabWidget::pane{border:1px solid #444;top:1px}QTabBar::tab:last{margin-right:0;border-top-right-radius:3px}QTabBar::tab:selected{border-top-left-radius:3px;border-top-right-radius:3px;margin-bottom:0}QRadioButton::indicator:checked,QRadioButton::indicator:unchecked{color:#b1b1b1;background-color:#323232;border:1px solid #b1b1b1;border-radius:6px}QRadioButton::indicator:checked{background-color:qradialgradient(cx: .5,cy: .5,fx: .5,fy: .5,radius: 1,stop: .25 #fa0,stop: .3 #323232)}QCheckBox::indicator{color:#b1b1b1;background-color:#323232;border:1px solid #b1b1b1;width:9px;height:9px}QRadioButton::indicator{border-radius:6px}QCheckBox::indicator:hover,QRadioButton::indicator:hover{border:1px solid #fa0}QCheckBox::indicator:checked{image:url(:/images/checkbox.png)}QCheckBox::indicator:disabled,QRadioButton::indicator:disabled{border:1px solid #444}");
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a VESTX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and vestx: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your VESTX addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified VESTX addresses"));
    ...
    openAction->setStatusTip(tr("Open a vestx: URI or payment request"));

    showHelpMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible VESTX command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to VESTX network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
...
{
    QString strTitle = tr("VESTX"); // default title
