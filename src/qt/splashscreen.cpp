    ...
    QWidget(0, f), curAlignment(0), m_node(node)
{
    ...
    QString copyrightTextFXTC  = QChar(0xA9) + QString("2018 ") + QString(tr("The FxTC developers"));
    QString copyrightTextXSN   = QChar(0xA9) + QString("2018 ") + QString(tr("The XSN developers"));
    QString copyrightTextVESTX = QChar(0xA9) + QString("2019 ") + QString(tr("The VESTX developers"));
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 36, copyrightTextXSN);
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 48, copyrightTextVESTX);
