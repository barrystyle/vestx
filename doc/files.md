...
* vestx.conf: contains configuration settings for vestxd or vestx-qt
* vestxd.pid: stores the process id of vestxd while running
...
* debug.log: contains debug information and general logging generated by vestxd or vestx-qt
