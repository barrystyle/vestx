...
This document provides guidelines for internationalization of the VESTX software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `vestx_en.ts` remains unchanged.
